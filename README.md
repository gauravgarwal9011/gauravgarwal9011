...
Feel free to explore my repositories, where I showcase projects from **Generative AI**, **RAG**,**Multimodal RAG**, **predictive analytics**, **data wrangling**, and **machine learning** to **business intelligence** using **Power BI**.
